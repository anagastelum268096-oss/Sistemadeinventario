...
interface EditGroupDialogProps {
  ...
  group: Group;
  onUpdateGroup: (id: string, group: Omit<Group, 'id'>) => void;
  teachers: Person[];
}
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-lg">
        <DialogTitle>Editar Grupo Artístico</DialogTitle>
        <DialogDescription>
          Modifica la información del grupo artístico. Todos los campos son obligatorios.
        </DialogDescription>
