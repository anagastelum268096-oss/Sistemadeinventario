  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-lg max-h-[90vh] overflow-y-auto">
        ...
        <DialogDescription>
          {role === 'teacher' 
            ? 'Completa la información del maestro. Solo el nombre es obligatorio.'
            : 'Completa la información del alumno. Solo el nombre es obligatorio, los demás campos son opcionales.'}
        </DialogDescription>
